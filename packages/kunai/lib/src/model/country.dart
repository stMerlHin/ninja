...
class Country {
  ...
  String get dialCodeString => '+$dialCode';

  String get dialCodeAndFlagString => '$flag +$dialCode';

  String get currencyString => [xofCurrency, xafCurrency].contains(currency) ? 'FCFA' : currency;
...
const String xofCurrency = 'XOF';
const String xafCurrency = 'XAF';
