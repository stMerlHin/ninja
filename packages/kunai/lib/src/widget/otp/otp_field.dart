...
import 'otp_field_cursor_painter.dart';
...
class OTPTextField extends StatefulWidget {
  ...
  final OTPHapticFeedbackTypes hapticFeedbackTypes;
  ...
  /// [OTPAnimationType] for the text to appear in the pin code field. Default is [OTPAnimationType.slide]
  ...
  final StreamController<OTPErrorAnimationType>? errorAnimationController;
  ...
  /// Configuration for paste dialog. Read more [OTPDialogConfig]
  final OTPDialogConfig? dialogConfig;

  /// Theme for the pin cells. Read more [OTPPinTheme]
  ...
  /// Text gradient for Pin code
  final Gradient? textGradient;

  /// Makes the pin cells readOnly
  final bool readOnly;

  /// Enable auto unfocused
  final bool autoUnfocused;
  ...
  OTPTextField({
    ...
    this.hapticFeedbackTypes = OTPHapticFeedbackTypes.light,
    ...
    this.dialogConfig,
    this.pinTheme = const OTPPinTheme.defaults(),
...
class _OTPTextFieldState extends State<OTPTextField>
  ...
  StreamSubscription<OTPErrorAnimationType>? _errorAnimationSubscription;
  ...
  OTPDialogConfig get _dialogConfig => widget.dialogConfig == null
      ? OTPDialogConfig()
      : OTPDialogConfig(
          ...
          builder: widget.dialogConfig!.builder,
        );
  OTPPinTheme get _pinTheme => widget.pinTheme;
  ...
  void initState() {
    ...
    _assignController();
    if (_pinTheme.shape != OTPCodeFieldShape.circle &&
        _pinTheme.shape != OTPCodeFieldShape.underline) {
    ...
    if (widget.errorAnimationController != null) {
      _errorAnimationSubscription =
        ...
        if (errorAnimation == OTPErrorAnimationType.shake) {
          _controller.forward();

          _setState(() => isInErrorMode = true);
        } else if (errorAnimation == OTPErrorAnimationType.clear) {
  ...
  runHapticFeedback() {
    switch (widget.hapticFeedbackTypes) {
      case OTPHapticFeedbackTypes.heavy:
        HapticFeedback.heavyImpact();
        break;

      case OTPHapticFeedbackTypes.medium:
        HapticFeedback.mediumImpact();
        break;

      case OTPHapticFeedbackTypes.light:
        HapticFeedback.lightImpact();
        break;

      case OTPHapticFeedbackTypes.selection:
        HapticFeedback.selectionClick();
        break;

      case OTPHapticFeedbackTypes.vibrate:
...
// selects the right fill color for the field
  ...
  Future<void> _showPasteDialog(String pastedText) {
    ...
    if (_dialogConfig.builder != null) {
      return _dialogConfig.builder!.call(formattedPastedText);
    }
    ...
    return showDialog(
      ...
      builder: (context) => _dialogConfig.platform == OTPPinCodePlatform.iOS
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: (_pinTheme.activeBoxShadows != null ||
                    ...
                    : widget.boxShadows,
                shape: _pinTheme.shape == OTPCodeFieldShape.circle
                    ? BoxShape.circle
                    : BoxShape.rectangle,
                borderRadius: borderRadius,
                border: _pinTheme.shape == OTPCodeFieldShape.underline
                    ? Border(
                        bottom: BorderSide(
              ...
              child: Center(
                child: AnimatedSwitcher(
                  ...
                  transitionBuilder: (child, animation) {
                    if (widget.animationType == OTPAnimationType.scale) {
                      return ScaleTransition(
                        scale: animation,
                        child: child,
                      );
                    } else if (widget.animationType == OTPAnimationType.fade) {
                      return FadeTransition(
                        opacity: animation,
                        child: child,
                      );
                    } else if (widget.animationType == OTPAnimationType.none) {
                      return child;
                    } else {
                      return SlideTransition(
  ...
  List<Widget> _getActionButtons(String pastedText) {
    ...
    if (_dialogConfig.platform == OTPPinCodePlatform.iOS) {
      resultList.addAll([
...
enum OTPCodeFieldShape { box, underline, circle }

enum OTPErrorAnimationType { shake, clear }
