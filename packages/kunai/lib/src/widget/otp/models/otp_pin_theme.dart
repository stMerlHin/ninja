...
class OTPPinTheme {
  ...
  /// Colors of the input fields if the [OTPTextField] is disabled. Default is [Colors.grey]
  ...
  /// Width of the input fields if the [OTPTextField] is disabled. Default is 2
  ...
  const OTPPinTheme.defaults({
    this.borderRadius = BorderRadius.zero,
    this.fieldHeight = 50,
    this.fieldWidth = 40,
    this.borderWidth = 2,
    this.fieldOuterPadding = EdgeInsets.zero,
    this.shape = OTPCodeFieldShape.underline,
